$(document).ready(function(){
    ...
    $.ajax({url: pdfFilesDirectory}).then(function(html) {
        ...
        document.find('a[href$=pdf]').each(function() {
            ...
            if($("#isAdmin").val() == 1 ){
                toAppend += "<form method='post' class='float-right' action=''><button class='btn btn-warning center' name='file' value='" + pdfName + "' type='submit'><i class=\"fas fa-trash-alt\"></i></button></form>";
            }
